      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row mb-2">
              <div class="col-sm-6"><h3 class="mb-0"> Subject List (Total : {{ $getRecord->total() }})</h3></div>
                ...
                <!--begin::Quick Example-->
                  ...
                  <form method="get" action="">
                    ...
                    <div class="row">
                      ...
                      <a href="{{ url('admin/subject/list') }}" class="btn btn-danger" style="margin-top: 24px;">Reset</a>
                    </div>
